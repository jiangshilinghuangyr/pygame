...
pygame.display.set_caption("HNU校园游")

pygame.mixer.music.load("static/sounds/xiaoge.mp3")
...
while running:
    ...
    if success_finished:
        screen.fill("black")
        draw_text(screen, "HNU!", 200, config.SCREEN_WIDTH / 2, config.SCREEN_HEIGHT / 2)
    else:
        if success_time >= 0:
